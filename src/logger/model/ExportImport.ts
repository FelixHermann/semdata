...
import {getAllDataNodes, getRootNode, ID_MANAGER, resetID_Manager, setRootNode} from "../App";
...
export function getExportAsJson() {
    let jsonObject = {};
    jsonObject["rootNode"] = getRootNode().getDataNodeId();
...
export function getDataNodes(jsonObject) {
    ...
    setRootNode(dataNodeProvider.get(rootNode));
}
